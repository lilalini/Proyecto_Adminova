...
class CleaningTaskFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'checklist' => fake()->randomElements(['cambiar sábanas', 'limpiar baño', 'aspirar', 'reponer amenities'], rand(2, 4)),
            'photos' => fake()->optional(0.3)->passThrough(['before.jpg', 'after.jpg']),
