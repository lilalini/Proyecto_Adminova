...
export class AdminShowComponent implements OnInit {
  ...
  getStatusClassForBooking(booking: Booking): string {
    return getStatusClass(getBookingStatus(booking));
  }

  getStatusTextForBooking(booking: Booking): string {
    return getStatusText(getBookingStatus(booking));
  }
}